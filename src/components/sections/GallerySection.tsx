...
export default function GallerySection() {
    ...
    return (
        <div id="gallery" className="relative w-full flex flex-col items-center px-6 pt-24 pb-24 overflow-hidden" style={{ background: "linear-gradient(180deg, #DCE3C8 0%, #ECF0DC 40%, #F0F3E3 60%, #F3F5E9 80%, #F7F8F0 100%)" }}>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: false, amount: 0.3 }} transition={{ duration: 1, ease: "easeOut" }} className="relative w-full max-w-[300px] aspect-video rounded-2xl overflow-hidden shadow-md bg-neutral-900 mb-12">
            ...
            <div className="w-full max-w-[300px]" style={{ columnCount: 2, columnGap: "0.75rem" }}>
